...
def finalize_top(X, y, top_models, grid_param, cv, random_state=123, report_dir=None, n_jobs=-1, return_params = False):
    """
    ...
    for model in top_models:
        ...
        if len(p_grid) > 0:
            ...
            try:
                ...
                best_r_squared_list.append(best_r_squared)
            ...
            with open(f'{report_dir}/gridsearch_results.txt', '+a') as f:
                f.write(f'Best {name} Model R-squared:\t{best_r_squared}\n')

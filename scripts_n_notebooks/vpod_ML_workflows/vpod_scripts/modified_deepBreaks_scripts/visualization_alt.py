...
from deepBreaks.models_alt import importance_from_pipe
from deepBreaks.utils_alt import stacked_barplot, box_plot
...
def dp_plot(importance, imp_col, model_name,
    ...
    if type(importance) is dict:
        ...
        importance = importance.sort_values(by = imp_col, ascending=False)

            ...
            if len(ls) > 0:
                ...
                if (vl[ls].sum() / X.shape[0]) < self.threshold:
                    ...
                    for letter in ls:
                        ...
                        #can remove this class from the pipeline because of continous variables
...
class AminoAcidPropertyEncoder(BaseEstimator, TransformerMixin):
    ...
    def __init__(self):
        ...
        #check if certain properties are correlated to each-other 
        #keith's paper he sent has infor on this
        #do a unsupervised learning cluster analysis of aa props to maybe narrow down significant props by gene family
        self.aa_properties = { 
            ...
            for j, aa in enumerate(seq):
                ...
                if aa in self.aa_properties: #Single amino acid
                    ...
                    for prop in avg_properties:
                        avg_properties[prop] = round(avg_properties[prop] / len(aa), 3)  # Round to 3 decimals

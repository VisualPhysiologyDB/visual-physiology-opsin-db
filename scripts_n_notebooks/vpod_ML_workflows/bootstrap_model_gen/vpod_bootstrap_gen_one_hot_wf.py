...
#path = './VPOD_1.3_data_splits_2024-08-20_16-14-09'
#meta_data_list = ['wds_meta.tsv','wt_meta.tsv','wt_vert_meta.tsv', 'inv_meta.tsv', 'vert_meta.tsv']
#seq_data_list = ['wds_aligned_VPOD_1.3_het.fasta','wt_aligned_VPOD_1.3_het.fasta','wt_vert_aligned_VPOD_1.3_het.fasta', 'inv_only_aligned_VPOD_1.3_het.fasta', 'vert_aligned_VPOD_1.3_het.fasta']
...
seq_data_list = ['wds_mnm_aligned_VPOD_1.3_het.fasta','wt_mnm_aligned_VPOD_1.3_het.fasta','wt_vert_mnm_aligned_VPOD_1.3_het.fasta', 'inv_mnm_aligned_VPOD_1.3_het.fasta', 'vert_mnm_aligned_VPOD_1.3_het.fasta']
...
for meta, seq, ds in zip(meta_data_list, seq_data_list, ds_list):
    ...
    report_dir = str(f'./vpod_1.3_bs/{ds}_bootstrap_{dt_label}')
